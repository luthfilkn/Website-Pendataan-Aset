...
<div class="page-wrapper">
        ...
        <div class="ml-auto text-right">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Data Non Standar Kampus</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <?php if (pg_admin()) { echo '<div class="col-md-6">';} else { echo '<div class="col-md-12">';} ?>
        ...
        <div class="card">
          <div class="card-header">
            <h4>Non Standar Kampus Ruang Dekan</h4>
          </div>
          <div class="card-body">
  ...
  <?php if (pg_admin() || pg_wakasek()):?>
    ...
    <div class="card">
      <div class="card-header">
        <h4>Non Standar Kampus Ruang Wakil Dekan</h4>
      </div>
      <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Tata Usaha</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Kepala Lab / Perpus</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Osis</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Ibadah</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Gudang</h4>
  </div>
  <div class="card-body">
...
<?php if (pg_admin()) { echo '<div class="col-md-6">';} ?>
  ...
  <div class="card">
    <div class="card-header">
      <h4>Non Standar Kampus Ruang Perpustakaan</h4>
    </div>
    <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Laboratorium</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Kelas</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang Dosen</h4>
  </div>
  <div class="card-body">
...
<div class="card">
  <div class="card-header">
    <h4>Non Standar Kampus Ruang UKS</h4>
  </div>
  <div class="card-body">
